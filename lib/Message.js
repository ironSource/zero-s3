...
function uploadData(client, callback) {
	client.put(this.payload.key, this.payload.data, this.uploadAttempts, uploadCallbackFactory(this, callback));
}

function uploadFile(client, callback) {
	client.putFile(this.payload.key, this.payload.path, this.uploadAttempts, uploadCallbackFactory(this, callback));
}
